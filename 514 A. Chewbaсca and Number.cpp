...
my solution on codeforces : https://codeforces.com/contest/514/submission/191210573
problem name: 514 A. Chewbaсca and Number
status: accepted
author:  LELLO 
*/
#include <bits/stdc++.h>
...
void LELLO(){
    ...
    {
        if((n[i]-'0') < 5 ||(( 9 - (n[i]-'0')) == 0 && !i )) {
            vc.push_back(n[i]-'0');
            continue; 
        }
        else {
            vc.push_back(9 - (n[i]-'0')) ;
        }
    }
    bool flag = false ;
