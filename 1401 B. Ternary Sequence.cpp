/*
problem link: https://codeforces.com/contest/1401/problem/B
my solution on codeforces : https://codeforces.com/contest/1401/submission/174598367
...
void LELLO()
{
    int x1 , y1 ,z1 ,x2 ,y2 ,z2 , sum(0) ; cin >> x1 >> y1 >> z1 >> x2 >> y2 >> z2 ; 
    // maximize the (2 , 1)
    int m = min(z1 , y2) ;
    sum += m *2;
    z1 -= m ;
    ...
    x1 -= m ;
    z2 -= m ;
    // in case there is reminder of (1, 2)
    m = min(y1 , z2) ;
    sum -= 2*m;
    cout<< sum <<endl;
}
